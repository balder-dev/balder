...
class SetupMethVarFeature(BetweenMethVarFeature):
    ...
    def do_something_as_var(self):
        ...
        RuntimeObserver.add_entry(
            ...
            "MethodVariation<VDeviceI><SetupMethVarFeature.do_something_as_var>", category="feature")
    ...
    def do_something_as_var(self):
        ...
        RuntimeObserver.add_entry(
            __file__, SetupMethVarFeature, SetupMethVarFeature.do_something_as_var,
            "MethodVariation<VDeviceII><SetupMethVarFeature.do_something_as_var>", category="feature")
    ...
    def do_something_as_var(self):
        ...
        RuntimeObserver.add_entry(
            __file__, SetupMethVarFeature, SetupMethVarFeature.do_something_as_var,
            "MethodVariation<VDeviceIII><SetupMethVarFeature.do_something_as_var>", category="feature")
