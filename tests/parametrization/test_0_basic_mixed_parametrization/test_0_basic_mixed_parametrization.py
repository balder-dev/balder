...
class Test0Envtester(Base0EnvtesterClass):
    ...
    def expected_data(self):
        ...
        for cur_test1_param in ['a1', 'a2', 'a3', 'a4']:
            for cur_test2_param in [1, 2, 3, 4]:
                test_a1_output.extend([                            # FIXTURE-CONSTRUCTION: balderglob_fixture_testcase
                            ...
                            {"cls": "ScenarioA", "meth": "test_a_1", "msg": f"execute Test `ScenarioA.test_a_1` with Parameter `test1={cur_test1_param}` and `test2={cur_test2_param}`"},
                            {"cls": "SetupFeatureI", "meth": "do_something", "category": "feature"},
                            {"cls": "SetupFeatureII", "meth": "do_something", "category": "feature"},
