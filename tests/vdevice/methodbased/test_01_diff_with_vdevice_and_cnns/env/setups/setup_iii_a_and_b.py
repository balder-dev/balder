...
class SetupIIIAAndB(balder.Setup):
    ...
    def fixture_session(self):
        RuntimeObserver.add_entry(__file__, SetupIIIAAndB, SetupIIIAAndB.fixture_session, category="fixture",
    ...
    def fixture_setup(self):
        RuntimeObserver.add_entry(__file__, SetupIIIAAndB, SetupIIIAAndB.fixture_setup, category="fixture",
                                  part="construction", msg="begin execution CONSTRUCTION of fixture")
    ...
    def fixture_scenario(self):
        RuntimeObserver.add_entry(__file__, SetupIIIAAndB, SetupIIIAAndB.fixture_scenario, category="fixture",
                                  part="construction", msg="begin execution CONSTRUCTION of fixture")
    ...
    def fixture_variation(self):
        RuntimeObserver.add_entry(__file__, SetupIIIAAndB, SetupIIIAAndB.fixture_variation, category="fixture",
                                  part="construction", msg="begin execution CONSTRUCTION of fixture")
    ...
    def fixture_testcase(self):
        RuntimeObserver.add_entry(__file__, SetupIIIAAndB, SetupIIIAAndB.fixture_testcase, category="fixture",
                                  part="construction", msg="begin execution CONSTRUCTION of fixture")
