...
class SetupIII(balder.Setup):
    ...
    def fixture_variation(self):
        ...
        self.SetupDevice1.s_i.do_something()
        self.SetupDevice2.s_ii.do_something()
        self.SetupDevice2.s_ii.do_something_as_var(31, "hello-from-var-fixt-const")
        ...
        self.SetupDevice1.s_i.do_something()
        self.SetupDevice2.s_ii.do_something()
        self.SetupDevice2.s_ii.do_something_as_var(34, "hello-from-var-fixt-teardown")
    ...
    def fixture_testcase(self):
        ...
        self.SetupDevice1.s_i.do_something()
        self.SetupDevice2.s_ii.do_something()
        self.SetupDevice2.s_ii.do_something_as_var(32, "hello-from-test-fixt-const")
        ...
        self.SetupDevice1.s_i.do_something()
        self.SetupDevice2.s_ii.do_something()
        self.SetupDevice2.s_ii.do_something_as_var(33, "hello-from-test-fixt-teardown")
