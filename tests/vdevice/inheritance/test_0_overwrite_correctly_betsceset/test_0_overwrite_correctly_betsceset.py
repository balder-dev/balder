...
def test_0_overwrite_correctly_betsceset(balder_working_dir):
    """
    ...
    device of the scenario. This feature will be overwritten by a direct child `FeatureOfRelevanceLvl2` that overwrites
    both vDevices. The setup device instantiates a child class (`SetupFeatureOfRelevanceLvl3`) of it.
