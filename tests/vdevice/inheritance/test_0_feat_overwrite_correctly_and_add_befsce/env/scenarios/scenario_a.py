import balder
import logging
from ..lib.features import FeatureIChild, FeatureII, FeatureOfRelevanceLvl2, FeatureNewI
...
class ScenarioA(balder.Scenario):
    ...
    class ScenarioDevice2(balder.Device):
        ii = FeatureII()
        relevance = FeatureOfRelevanceLvl2(VDeviceWithI="ScenarioDevice1")
    ...
    def test_a_1(self):
        ...
        self.ScenarioDevice1.new.do_something()
