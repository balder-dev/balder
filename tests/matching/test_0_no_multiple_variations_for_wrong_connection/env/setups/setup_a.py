...
from ..lib.connections import AConnection, CConnection
...
class SetupA(balder.Setup):
    ...
    class SetupDevice2a(balder.Device):
        s_ii = SetupFeatureII()

    # device uses a CConnection that is not used in the scenario -> should not match
    @balder.connect(SetupDevice1, over_connection=CConnection)
    class SetupDevice2b(balder.Device):
        s_ii = SetupFeatureII()
    ...
    def fixture_session(self):
        ...
        self.SetupDevice2a.s_ii.do_something()
        self.SetupDevice2b.s_ii.do_something()
