...
class SetupA(balder.Setup):
    ...
    def unclear_fixture(self):
        RuntimeObserver.add_entry(__file__, SetupA, SetupA.unclear_fixture, category="fixture", part="construction",
        ...
        RuntimeObserver.add_entry(__file__, SetupA, SetupA.unclear_fixture, category="fixture", part="teardown",
