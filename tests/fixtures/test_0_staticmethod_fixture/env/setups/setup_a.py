...
class SetupA(balder.Setup):
    ...
    def fixture_setup_setup(balderglob_fixture_setup, fixture_setup_session):
        RuntimeObserver.add_entry(__file__, SetupA, SetupA.fixture_setup_setup, category="fixture",
                                  part="construction", msg="begin execution CONSTRUCTION of fixture")

        SetupA.SetupDevice1.s_i.do_something()
        SetupA.SetupDevice2.s_ii.do_something()
    ...
    def fixture_setup_variation(balderglob_fixture_variation, fixture_setup_scenario):
