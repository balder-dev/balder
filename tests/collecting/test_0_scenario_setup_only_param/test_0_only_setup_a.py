...
class Test0OnlySetupA(Base0EnvtesterClass):
    """
    ...
    `balder .. --only-with-setup setups/*_a.py`

    Only the elements matching with `SetupA` should be executed here.
    """
    @property
    def cmd_args(self):
        return ["--only-with-setup", "setups/*_a.py"]
