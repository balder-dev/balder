...
def test_0_treecheck_fixt_balderglob_scenario_construction(balder_working_dir):
    """
    ...
    file: ``balderglob.py``
    class: -
    method/function: ``balderglob_fixture_scenario``
    part: ``construction``
    """
...
def processed(env_dir):
    ...
    session = BalderSession(cmd_args=[
        ...
        '--test-error-meth', 'balderglob_fixture_scenario',
    ...
    expected_data = (
        ...
        [
            (
                ...
                # this should stop the execution here - also the teardown should be skipped for now
