...
def test_0_treecheck_fixt_balderglob_variation_construction(balder_working_dir):
    """
    ...
    file: ``balderglob.py``
    class: -
    method/function: ``balderglob_fixture_variation``
    part: ``construction``
    """
...
def processed(env_dir):
    ...
    session = BalderSession(cmd_args=[
        ...
        '--test-error-meth', 'balderglob_fixture_variation',
